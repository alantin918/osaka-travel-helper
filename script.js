document.addEventListener('DOMContentLoaded', () => {
  ...
  const cardData = [
    ...
    { rank: 2, name: '富邦 J 卡 💳 (日韓泰・單筆≥NT$1,000)', type: 'card', rate: 0.045, limit: Infinity, maxRebate: Infinity, feeDesc: '標示 6.0% 扣 1.5% 海外手續費 (每月20日16:00搶登錄・需單筆滿千)' },
    ...
    { rank: 6, name: '星展 eco/極簡卡 (兩張) 💳', type: 'card', rate: 0.035, limit: 30000, maxRebate: 1050, feeDesc: '標示 5.0% 扣 1.5% 海外手續費 (兩張各自上限 NT$15,000，合計 NT$30,000)' },
